...
1. **Belum diselesaikan** — mapping asset_id PD–DGA riil belum ada. Prototype memakai data PD **simulasi** (diskalakan dari kadar H2 riil) karena data PD produksi masih berisi asset_id dummy yang tidak match ke 69 aset DGA riil.
...
| Mapping asset_id PD–DGA | Korelasi lintas modul | — | [isi] | Database Pemeliharaan | **Belum dilaksanakan** — [belum ada evidence]. Ini alasan data PD di prototype masih simulasi |
